    ...
    <div class="dw-d-bg dw-d-bg--left dw-d-bg--medium dw-d-parallax"></div>
            <div class="integration-inner" style="position: relative; z-index: 2;">
                ...
                <div class="integration-links">
                    <a href="/products/mes/" class="integration-link">Explore MES <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
                    <a href="/products/wms/" class="integration-link">Explore WMS <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
                    <a href="/products/aiot/" class="integration-link">Explore AIoT <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
                </div>
            </div>
    </div>
    `;
