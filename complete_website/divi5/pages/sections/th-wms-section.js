/**
 * th-wms-section.js — Thai WMS Section (S2) — COPY
 *
 * Same layout/CSS as English wms-section.js, Thai strings from i18n.
 */
...
function blocks() {
  ...
  return base.wrapInDiviSection('Section: WMS คืออะไร? (Thai)', html, 'Section: Content');
}

// Reuse English CSS
const { css } = require('./wms-section');
