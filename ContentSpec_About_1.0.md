...
| **Background** | Dark gradient (#1a2e40 → #253B50 → #2d4a5e) with grain texture overlay |
...
| Element | Content |
|---------|---------|
| **Headline** | We Power Manufacturing's `<span style="color:#3798E4">Digital Future</span>` |
...
| Element | Content |
|---------|---------|
| **Chinese** | 鼎新 (Noto Sans TC, 32px, bold) |
...
| **Background** | Dark gradient (#253B50 → #1a2e40) with grain texture |
...
| **Year** | JetBrains Mono, 14px, #3798E4 |
| **Title** | Lexend 600, 14px, white 0.95 |
...
|----------|-------|
| **Size** | 14px diameter |
| **Background** | #253B50 with 3px border #3798E4 |
| **Connector** | 24px vertical line from dot to card |
| **Active glow (2014, 2026)** | Background #3798E4, box-shadow 6px glow |
...
| **Fade masks** | Pseudo-elements on `.timeline-scroll-container` — 60px linear-gradient from `#253B50` → transparent at left and right edges |
...
| # | Value | Label | Style |
|---|-------|-------|-------|
| 1 | 44+ | Years in Manufacturing ERP | Blue (#3798E4) |
| 2 | 50K+ | Manufacturing Clients Worldwide | Blue (#3798E4) |
| 3 | 100+ | Thai Implementations | Blue (#3798E4) |
| 4 | 50+ | Team Members in Thailand | Blue (#3798E4) |
...
| Element | Content |
|---------|---------|
| **Headline** | Because of DigiWin, `<span style="color:#3798E4">You Can...</span>` |
...
Dark bar (#253B50 → #1a2e40), centered flex layout:
...
| **Background** | Blue gradient (#3798E4 → #2d7bc4 → #1e5a8a) with grain texture |
| **Padding** | 100px top/bottom |
