...
| Upcoming Events Grid | 3-column event cards, color-coded by type: Seminar (#00AFF0), Workshop (#02D28C), Factory Visit (#FFD700), Trade Show (#644CE6) | Card grid |
...
| Body | Max-width 800px, Noto Sans headings, Noto Sans body 18px/1.8 line-height |
| Pull Quotes | Blue left border (#00AFF0), italic, larger font |
...
> - Background: partner-hero-factory.jpg (1920×800) with #000864 overlay at 65%
> - CTA Button: "Explore the Partner Program" in #00AFF0
...
## 7. Design System (Official DigiWin Brand Kit — aligned Feb 2026)

The Thailand website follows the official DigiWin Brand Guidelines (84-page PDF + Illustrator source). All design decisions below are aligned to the corporate brand kit, adapted for the Thai local market.

### 7.1 Color Palette (Official Brand Kit)

| Role | Color | Hex | CSS Variable | Usage |
|------|-------|-----|-------------|-------|
| Smart Blue | Primary Blue | #00AFF0 | `--dw-blue` | CTA buttons, links, active states, icon accents |
| Dark Navy | Footer/Header Dark | #000864 | `--dw-navy` | Footer background, hero overlays, dark sections |
| Navy Deep | Gradient Dark | #000432 | `--dw-navy-deep` | Hero gradient dark end |
| Navy Mid | Gradient Mid | #001080 | `--dw-navy-mid` | Hero gradient mid |
| Royal Blue | Secondary Blue | #003CC8 | `--dw-royal` | Headings on dark, secondary accents |
| Cyan Accent | Tech Highlight | #00E6FF | `--dw-cyan` | Particle wave, tech accents |
| White | Background | #FFFFFF | — | Page backgrounds, card backgrounds |
| Light Gray | Section Alternate | #F5F7FA | `--dw-gray-light` | Alternating section backgrounds for visual rhythm |
| Text Dark | Primary Text | #333333 | `--dw-text` | Body text, headings |
| Text Light | Secondary Text | #666666 | `--dw-text-light` | Subheadings, descriptions, meta text |
| Purple | Category Accent | #644CE6 | `--dw-purple` | Trade shows, tech categories |
| Green | Success/Growth | #02D28C | `--dw-green` | Growth indicators, workshops |
| Coral | Attention | #FF6E82 | `--dw-coral` | Alerts, highlights |
| Yellow | Premium/Gold | #FFD700 | `--dw-yellow` | Awards, premium tiers |

**Color ratio:** 60% Smart Blue / 30% navy+royal+cyan / 10% accent colors

### 7.2 Typography (Official Brand Kit — Noto Sans)

DigiWin brand kit specifies Noto Sans as the official typeface for all languages:

- Headings: Noto Sans Bold (700), 40-48px hero, 32px section heads, 24px sub-heads
- Subtitles: Noto Sans Medium (500)
- Body: Noto Sans Regular (400), 16-18px, line-height 1.5-1.6
- Labels/Badges: JetBrains Mono (monospace, technical differentiation)
- Chinese: Noto Sans SC (Simplified Chinese per brand kit)
- Thai text: Noto Sans Thai for Thai glyph support
...
- All heroes: dark overlay gradient (#000864 at 60-70% opacity) for text readability
- **Photography categories (brand kit pp.75-78):**
  - Brand: Abstract flowing particles, cyan/blue on dark navy (hero backgrounds, CTA sections)
  - Technology: Factory/industrial with subtle blue color cast (product pages, feature showcases)
  - Humanistic: Warm natural tones, genuine people moments (about, partner, team sections)
- Technology/Brand photos: subtle blue overlay via CSS (mix-blend-mode with #00AFF0 at 15%)

### 7.3b Brand Graphic System (Official Brand Kit)

Two core visual instruments define the DigiWin visual identity:

- **Super D (超级符号):** The D mark extracted from the logo, used as a standalone background device. Always cropped/bleeding off edges — never floating centered. Treatments: wireframe, line art, particle-fill, solid, gradient, data texture.
- **Particle Wave (数据洋流):** Dot-matrix pattern representing data flow. Variations: full wave (hero/CTA), dot fade (section transitions), abstract circles (subtle backgrounds). Always flows horizontally.
...
| CTA Button | "Let's Talk" — #00AFF0 background, white text, right-aligned |
...
| 14 | SVG icon style guide | â“ Decision needed | Claude | Outline vs. filled, color (monochrome #00AFF0 vs. multi-color), size standard |
