/**
 * th-demo-hero.js — Thai Hero Section (S1) — Contact page
 */
...
function blocks() {
  const html = `
    ...
    <div class="demo-hero-inner">
      <h1>พูดคุยเรื่อง<span>โรงงานของคุณ</span></h1>
      <p class="demo-hero-subtitle">ไม่ว่าคุณจะเป็นเจ้าของโรงงานที่กำลังมองหาโซลูชัน หรือผู้จัดจำหน่ายที่สนใจเป็นพาร์ทเนอร์ — เราพร้อมรับฟังก่อน แล้วจึงนำเสนอสิ่งที่เหมาะสมกับคุณ</p>
      <div class="demo-trust">
        <div class="demo-trust-item">
          <span class="demo-trust-value dw-years">44</span>
          <span class="demo-trust-label">ปีแห่งประสบการณ์</span>
        </div>
        <div class="demo-trust-item">
          <span class="demo-trust-value">50K+</span>
          <span class="demo-trust-label">โรงงานทั่วโลก</span>
        </div>
        <div class="demo-trust-item">
          <span class="demo-trust-value">100+</span>
          <span class="demo-trust-label">ลูกค้าในไทย</span>
        </div>
        <div class="demo-trust-item">
          <span class="demo-trust-value">300378</span>
          <span class="demo-trust-label">จดทะเบียนในตลาดหลักทรัพย์</span>
        </div>
      </div>
    </div>    </div>`;
...
.demo-hero h1{font-family:'Noto Sans Thai',sans-serif;font-size:clamp(32px,5vw,48px);font-weight:700;color:#fff;margin-bottom:20px;line-height:1.3}
