...
| **Headline** | `Stop Building Custom Code.` (line break) `Start Deploying a Modular Arsenal.` — second line in `#00AFF0` |
...
| Element | Content |
|---------|---------|
| **Section Label** | "CUSTOMER LIFECYCLE MANAGEMENT" (JetBrains Mono, `#00AFF0`) |
...
|-------|--------|-------|-------|----------|-------------|-------------|
| 1 | 1 | Blue `#00AFF0` | Land | iGP (Volume) or eMES (Reverse Cut) | Entry point with immediate value. Fast project, quick cash. | Project fees + License |
...
| Element | Specification |
|---------|---------------|
| **Layout** | Dark box (`linear-gradient(135deg, #000864, #1a2e40)`), 3-column comparison |
...
| Element | Specification |
|---------|---------------|
| **Layout** | Dark box (`linear-gradient(135deg, #000864, #1a2e40)`) with dot pattern, centered text |
