...
| **Headline** | `Built for What <span>OEMs Demand</span>` (h1, Noto Sans 700, clamp 40-56px; span in #00AFF0) |
...
| Element | Content |
|---------|---------|
| **Headline** | `Thailand: ASEAN's Detroit` (Noto Sans, from shared styles) |
...
| Element | Content |
|---------|---------|
| **Headline** | `The Automotive Stakes Are High` (Noto Sans, from shared styles) |
...
| Element | Content |
|---------|---------|
| **Headline** | `Integrated with Major OEM Systems` (h3, Noto Sans, 24px) |
