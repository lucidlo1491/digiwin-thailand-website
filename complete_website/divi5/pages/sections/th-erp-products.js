...
function blocks() {
  ...
  const erpiiModulesHTML = t.igp.erpiiModules.map((m, i) => {
    ...
    const mesLink = i === 4 ? `<a href="/products/mes/" style="color: inherit; text-decoration: underline; text-decoration-color: #0369a1; text-underline-offset: 2px;">${m.name}</a>` : m.name;
    return `
