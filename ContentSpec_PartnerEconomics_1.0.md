...
| **Value Style** | Lexend 32px bold, `#4ade80` |
...
| Element | Content |
|---------|---------|
| **Section Label** | "THE 4 REVENUE STREAMS" (JetBrains Mono, uppercase, `#3798E4`, letter-spacing 2px) |
...
Each card has: dark header (`linear-gradient(135deg, #253B50, #1a2e40)`) with icon + title + tag, followed by white body with description + margin grid + note.
...
| Element | Content |
|---------|---------|
| **Header** | Year 2 gradient: blue (`#3798E4 → #2d7bc4`) |
| **Badge** | "Year 2" |
...
| Element | Specification |
|---------|---------------|
| **Layout** | Dark box (`linear-gradient(135deg, #253B50, #1a2e40)`), centered, 3 vertical bars |
| **Title** | "3-Year Revenue Trajectory" |

| Year | Value | Label | Bar Color | Relative Height |
|------|-------|-------|-----------|----------------|
| Y1 | ฿2M | Y1: Surviving | Blue (`#3798E4`) | 27% |
| Y2 | ฿4.7M | Y2: Profitable | Blue (`#3798E4`) | 63% |
