...
| **Background** | Dark gradient: `linear-gradient(165deg, #0f1419 0%, #1a2632 40%, #253B50 100%)` with grain overlay |
...
| Element | Specification |
|---------|---------------|
| **Layout** | 2-column grid, dark navy gradient background (#253B50 → #1e3a5f), 48px padding, 20px radius |
...
| **Background** | Blue gradient: `linear-gradient(135deg, #3798E4 0%, #2d7bc4 50%, #1e5a8a 100%)` with grain texture |
