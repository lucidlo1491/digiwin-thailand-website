...
| **Background** | `linear-gradient(135deg, #1a2e40 0%, #000864 50%, #2d4a5e 100%)` with dot pattern overlay (`opacity: 0.03`) |
...
### Insight Box (dark: `linear-gradient(135deg, #000864, #1a2e40)` with diamond pattern)
