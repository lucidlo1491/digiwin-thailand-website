...
|------|-------------|-------|----------|
| Seminar | `--event-color: #3798E4` | Blue | `rgba(55,152,228,0.12)` |
...
**Layout:** Dark gradient background (165deg, #0f1419 → #1a2632 → #253B50) with grain texture overlay and event-color radial accent. Back link to News hub. Centered content.
...
```
- Links to `news.html`
- Style: Same as blog back link (Source Sans 3, 15px, rgba(255,255,255,0.6))
...
```
- Lexend 700, clamp(28px, 4.5vw, 44px), #fff
- Max-width: 800px
...
```
- Source Sans 3, 18px, rgba(255,255,255,0.85), max-width: 700px
...
- Values: Lexend 600, 16px, #fff
- Labels: Source Sans 3, 13px, rgba(255,255,255,0.6)
...
```
- Links to `demo.html`
- Style: var(--event-color) background, white text, Lexend 600 16px
...
```
- Source Sans 3, 18px, #333, line-height 1.8
...
- JetBrains Mono numbers, Source Sans 3 label
...
- Detail: Source Sans 3, 15px, #64748b, line-height 1.6
...
- Title: Lexend 600, 18px, #253B50
- Description: Source Sans 3, 15px, #64748b
...
- Role: Lexend 600, 20px, #253B50
- Factory Size: JetBrains Mono, 12px, var(--event-color), uppercase badge
- Challenge: Source Sans 3, 15px, #64748b, italic, in quotes
...
- Values: Lexend 700, 42px, var(--event-color)
- Labels: Source Sans 3, 14px, rgba(255,255,255,0.7)
...
- Labels: Lexend 600, 14px, #253B50
- Values: Source Sans 3, 16px, #333
...
```
- Source Sans 3, 18px, rgba(255,255,255,0.85)
...
|---------|------|------|--------|-------|
| Back link | Source Sans 3 | 15px | 500 | rgba(255,255,255,0.6) |
| Hero badge | JetBrains Mono | 12px | 500 | var(--event-color) |
| Hero headline | Lexend | clamp(28px, 4.5vw, 44px) | 700 | #fff |
| Hero subtitle | Source Sans 3 | 18px | 400 | rgba(255,255,255,0.85) |
| Quick facts values | Lexend | 16px | 600 | #fff |
| Section labels | JetBrains Mono | 12px | 500 | var(--event-color) |
| Section titles | Lexend | 36px | 700 | #253B50 |
| Body text | Source Sans 3 | 18px | 400 | #333333 |
| Card titles | Lexend | 18-20px | 600 | #253B50 |
| Card body | Source Sans 3 | 15px | 400 | #64748b |
| Agenda time | JetBrains Mono | 13px | 500 | var(--event-color) |
| CTA buttons | Lexend | 16px | 600 | #fff on var(--event-color) |
