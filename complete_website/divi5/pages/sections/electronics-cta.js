/**
 * electronics-cta.js — Cta Section (S9)
 *
 * AUTO-GENERATED by scaffold-builder.js — review and customize before pushing.
 * Source: electronics.html line 748
 *
 * styles.css: 29 base, 2 hover, 0 pseudo, 1 hidden
 * Original classes: cta-section, fade-in, dw-d-bg, dw-d-bg--center, dw-d-bg--gradient (+5 more)
 */
...
function blocks() {
  const html = `
    ...
    <div class="dw-d-bg dw-d-bg--center dw-d-bg--gradient" style="opacity: 0.10;"></div>
            <div class="dw-wave-flow" style="opacity: 0.08;"></div>
            <div class="cta-inner" style="position: relative; z-index: 2;">
                <h2>Master Electronics Complexity</h2>
                <p>See how DigiWin handles high-mix manufacturing</p>
