...
module.exports = {
  ...
  verify: {
    ...
    sections: [
      ...
      { name: 'mission', wpSelector: '.et_pb_section_1', htmlSelector: '.mission-section', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.mission-section h2', wpSel: '.et_pb_section_1 h2' }] },
      { name: 'timeline', wpSelector: '.et_pb_section_2', htmlSelector: '.timeline-section', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.timeline-section h2', wpSel: '.et_pb_section_2 h2' }] },
      { name: 'stats-banner', wpSelector: '.et_pb_section_3', htmlSelector: '.stats-banner', pixelThreshold: 0.1,
        styleMap: [{ label: 'Stat Value', htmlSel: '.stats-banner .stat-value', wpSel: '.et_pb_section_3 .stat-value' }] },
      { name: 'market-leadership', wpSelector: '.et_pb_section_4', htmlSelector: '.market-leadership', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.market-leadership h2', wpSel: '.et_pb_section_4 h2' }] },
      { name: 'beliefs', wpSelector: '.et_pb_section_5', htmlSelector: '.beliefs-section', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.beliefs-section h2', wpSel: '.et_pb_section_5 h2' }] },
      { name: 'outcomes', wpSelector: '.et_pb_section_6', htmlSelector: '.outcomes-section', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.outcomes-section h2', wpSel: '.et_pb_section_6 h2' }] },
      { name: 'thailand', wpSelector: '.et_pb_section_7', htmlSelector: '.thailand-section', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.thailand-section h2', wpSel: '.et_pb_section_7 h2' }] },
      { name: 'asia-presence', wpSelector: '.et_pb_section_8', htmlSelector: '.asia-presence', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.asia-presence h2', wpSel: '.et_pb_section_8 h2' }] },
      { name: 'awards', wpSelector: '.et_pb_section_9', htmlSelector: '.awards-section', pixelThreshold: 0.1,
