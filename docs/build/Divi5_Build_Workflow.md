...
|----------|-------|---------|
| Primary Blue | #00AFF0 | CTAs, links, accents |
| Dark Navy | #000864 | Dark sections, footer |
| Light Gray | #F5F7FA | Alternating section backgrounds |
| Text Dark | #333333 | Primary body text |
| Text Light | #64748b | Secondary text |
| Heading Font | Noto Sans | All H1-H6 |
| Body Font | Noto Sans | Paragraphs |
...
| Colors use Design Variables | Never hardcode #00AFF0 — reference the variable |
...
| Fonts are correct | Headings: Noto Sans. Body: Noto Sans. Labels: JetBrains Mono. |
...
| Design System | Colors: #00AFF0, #000864, #F5F7FA, #333, #64748b only |
| Typography | Noto Sans headings, Noto Sans body, JetBrains Mono labels |
