/**
 * th-demo-expect.js — Thai What to Expect Section (S3) — Contact page
 */
  ...
  const html = `
    ...
    <div class="demo-expect-inner" style="position:relative;z-index:2;">
      <div class="demo-expect-header">
        ...
        <p>ไม่มีการกดดัน ไม่มีข้อผูกมัด แค่พูดคุยเกี่ยวกับสิ่งที่เป็นไปได้</p>
      </div>
      <div class="expect-steps">
        <div class="expect-step">
          <div class="step-number">1</div>
          <h3>สนทนาเพื่อทำความเข้าใจ</h3>
          <p>เราจะเรียนรู้เกี่ยวกับโรงงาน ความท้าทาย และเป้าหมายของคุณ เราถามก่อนเสมอ — ไม่มีการขายแบบกดดัน ใช้เวลา 30-45 นาที</p>
        </div>
        <div class="expect-step">
          <div class="step-number">2</div>
          <h3>สาธิตเฉพาะที่คุณต้องการ</h3>
          <p>ดูเฉพาะผลิตภัณฑ์ที่เหมาะกับความต้องการของคุณ เราจะเน้นที่อุตสาหกรรมและกรณีการใช้งานเฉพาะของคุณ ไม่ใช่สไลด์ทั่วไป</p>
        </div>
        <div class="expect-step">
          <div class="step-number">3</div>
          <h3>ประเมินอย่างตรงไปตรงมา</h3>
          <p>หากเหมาะสม เราจะเสนอรายละเอียดให้ หากไม่เหมาะ เราจะบอกตรงๆ เราอยากสร้างความไว้วางใจมากกว่าบังคับขาย</p>
        </div>
      </div>
    </div>
    </div>`;
...
.demo-expect-header h2{font-family:'Noto Sans Thai',sans-serif;font-size:36px;font-weight:700;color:#000864;margin-bottom:12px}
...
.expect-step h3{font-family:'Noto Sans Thai',sans-serif;font-size:18px;font-weight:600;color:#000864;margin-bottom:12px}
