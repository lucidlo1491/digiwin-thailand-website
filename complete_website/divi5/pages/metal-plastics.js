...
module.exports = {
  pageId: 100567,
  title: 'Metal & Plastics Processing ERP & MES Thailand — DigiWin',
  siteUrl: 'https://digiwin-thailand.local',
  specPath: path.join(__dirname, '..', '..', '..', 'docs', 'content-specs', 'ContentSpec_MetalPlastics_Divi5_2.0.md'),
  ...
  verify: {
    wpUrl: 'https://digiwin-thailand.local/?page_id=100567',
    sections: [
      {
        name: 'metal-hero', wpSelector: '.et_pb_section_0', htmlSelector: '.metal-hero',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'Hero Title', htmlSel: '.metal-hero h1', wpSel: '.et_pb_section_0 h1' },
        ],
      },
      {
      ...
      {
        name: 'specialized-erp', wpSelector: '.et_pb_section_4', htmlSelector: '.specialized-erp-section',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'Section Title', htmlSel: '.specialized-erp-section h2', wpSel: '.et_pb_section_4 h2' },
        ],
      },
      {
        name: 'metal-case-study', wpSelector: '.et_pb_section_5', htmlSelector: '.metal-case-study',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'Section Title', htmlSel: '.metal-case-study h2', wpSel: '.et_pb_section_5 h2' },
        ],
      },
      {
        name: 'processes', wpSelector: '.et_pb_section_6', htmlSelector: '.processes-section',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'Section Title', htmlSel: '.processes-section h3', wpSel: '.et_pb_section_6 h3' },
        ],
      },
      {
        name: 'products', wpSelector: '.et_pb_section_7', htmlSelector: '.products-section',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'Section Title', htmlSel: '.products-section h2', wpSel: '.et_pb_section_7 h2' },
        ],
      },
      {
        name: 'metal-faq', wpSelector: '.et_pb_section_8', htmlSelector: '.metal-faq',
        pixelThreshold: 0.1,
        styleMap: [
          { label: 'FAQ Title', htmlSel: '.metal-faq h2', wpSel: '.et_pb_section_8 h2' },
        ],
      },
      {
