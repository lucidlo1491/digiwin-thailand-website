...
| **Heading (H1)** | Lexend, 36px, color `#253B50` |
| **Subheading date** | Default font, color `#64748b`, margin-bottom 48px |
| **Section Headings (H2)** | Lexend, 24px, margin 32px top / 16px bottom |
| **Body Text** | Source Sans 3, 16px, line-height 1.8, color `#253B50` |
| **Lists** | Standard `<ul>`, padding-left 24px, margin 16px top/bottom |
| **Link Color** | `#3798E4` (on email link) |
