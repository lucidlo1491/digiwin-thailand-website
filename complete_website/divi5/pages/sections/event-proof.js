...
.${P}-title{font-family:'Noto Sans',sans-serif;font-size:36px;font-weight:700;color:#000864;line-height:1.3;margin:0 0 40px;padding:0}
...
.${P}-stat-value{font-family:'Noto Sans',sans-serif;font-size:42px;font-weight:700;color:#22C55E;line-height:1.2}
.${P}-stat-label{font-family:'Noto Sans',sans-serif;font-size:14px;font-weight:400;color:rgba(255,255,255,0.7);margin-top:4px}
.${P}-text{font-family:'Noto Sans',sans-serif;font-size:18px;font-weight:400;color:#5b6b80;line-height:1.7;max-width:700px;margin:0 auto;padding:0}

.et_pb_section .${P}-title{-webkit-font-smoothing:auto !important;line-height:1.3 !important;margin:0 0 40px !important;padding:0 !important}
.et_pb_section .${P}-text{-webkit-font-smoothing:auto !important;padding-bottom:0 !important}
.et_pb_section .${P}-stat-value,.et_pb_section .${P}-stat-label{-webkit-font-smoothing:auto !important}
