...
**Layout:** Centered text on dark navy gradient (135deg, #1a2e40 → #253B50 → #2d4a5e) with dot grain texture overlay.
...
Meets Action
```
- "Action" in #3798E4 blue
- Font: Lexend 700, clamp(32px, 5vw, 52px)
...
**Card Design:**
- Left panel: dark gradient (#1a2e40 → #253B50), contains SVG calendar icon + event metadata
...
| Type | Color | Badge BG |
|------|-------|----------|
| Seminar | #3798E4 | rgba(55,152,228,0.1) |
...
- Title: Lexend 600, 18px
- Metadata: Source Sans 3, 14px, icons for date/time/location
...
| Hero headline | Lexend | clamp(32px, 5vw, 52px) | 700 | #fff / #3798E4 |
...
| Body text | Source Sans 3 | 16px | 400 | #333333 |
| Badges/Labels | JetBrains Mono | 11-13px | 500 | Various |
| CTA buttons | Lexend | 16px | 600 | #fff on #3798E4 |
