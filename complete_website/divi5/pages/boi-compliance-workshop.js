...
module.exports = {
  ...
  verify: {
    ...
    sections: [
      ...
      { name: 'event-problem', wpSelector: '.et_pb_section_1', htmlSelector: '.event-section--white:nth-of-type(1)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section:nth-of-type(1) h2', wpSel: '.et_pb_section_1 h2' }] },
      { name: 'event-outcomes', wpSelector: '.et_pb_section_2', htmlSelector: '.event-section--gray:nth-of-type(1)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--gray:nth-of-type(1) h2', wpSel: '.et_pb_section_2 h2' }] },
      { name: 'event-agenda', wpSelector: '.et_pb_section_3', htmlSelector: '.event-section--white:nth-of-type(2)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--white:nth-of-type(2) h2', wpSel: '.et_pb_section_3 h2' }] },
      { name: 'event-personas', wpSelector: '.et_pb_section_4', htmlSelector: '.event-section--gray:nth-of-type(2)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--gray:nth-of-type(2) h2', wpSel: '.et_pb_section_4 h2' }] },
      { name: 'event-proof', wpSelector: '.et_pb_section_5', htmlSelector: '.event-section--white:nth-of-type(3)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--white:nth-of-type(3) h2', wpSel: '.et_pb_section_5 h2' }] },
      { name: 'event-logistics', wpSelector: '.et_pb_section_6', htmlSelector: '.event-section--gray:nth-of-type(3)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--gray:nth-of-type(3) h2', wpSel: '.et_pb_section_6 h2' }] },
      { name: 'event-register', wpSelector: '.et_pb_section_7', htmlSelector: '.event-register-cta', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-register-cta h2', wpSel: '.et_pb_section_7 h2' }] },
      { name: 'event-related', wpSelector: '.et_pb_section_8', htmlSelector: '.event-section--gray:nth-of-type(4)', pixelThreshold: 0.1,
        styleMap: [{ label: 'H2', htmlSel: '.event-section--gray:nth-of-type(4) h2', wpSel: '.et_pb_section_8 h2' }] },
    ],
  },
};
